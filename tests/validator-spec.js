...
describe('validator', function() {
  ...
  var testCases = [
    ...
    [ 'input[type=text][minlength=3]:invalid',
      '<input type="text" name="text-minlength-s0" minlength="3" value="a" />',
      testRequiredInvalid,
      'text-minlength-s0'
    ],
    [ 'input[type=text][minlength=3]:invalid',
      '<input type="text" required name="text-minlength-0" minlength="3" />',
      testRequiredInvalid,
      'text-minlength-0'
    ],
    ...
    [ 'input[type=checkbox][minlength=3][value="123"]:valid',
      '<input type="checkbox" name="checkbox-minlength-2" minlength="3" value="123" />',
      testRequiredValid,
      'checkbox-minlength-2'
    ],
  ...
  for(var i=0,l=testCases.length; i<l; i++){
    ...
    var desc = testCases[i][1] + ':' +
      (getFunctionName(handler)==='testRequiredValid'?"valid":"invalid");
